...
var highBreak = Math.floor(Math.random()*(190-151+1)) + 151;  /* 고성능 버튼 랜덤숫자 */
var speed = 60;
function basicrun(){
  if(NRD==Breaknum){
...
function highrun(){
  ...
  if(NRD==1||NRD==11||NRD==21||NRD==31||NRD==41||NRD==51
    ||NRD==52||NRD==71||NRD==72||NRD==91||NRD ==92||NRD==111
    ||NRD==112||NRD==113||NRD==114||NRD==151||NRD==152||NRD==153||NRD==154){
      document.getElementById("onebox").style.backgroundColor="#F5EBB0";
      document.getElementById("twobox").style.backgroundColor="#DAD061";
      document.getElementById("threebox").style.backgroundColor="#DAD061";
      document.getElementById("fourbox").style.backgroundColor="#DAD061";
      document.getElementById("fivebox").style.backgroundColor="#DAD061";
      document.getElementById("sixbox").style.backgroundColor="#DAD061";
      document.getElementById("sevenbox").style.backgroundColor="#DAD061";
    ...
    ||NRD==54||NRD==73||NRD==74||NRD==93||NRD==94||NRD==115
    ||NRD==116||NRD==117||NRD==118||NRD==155||NRD==156||NRD==157||NRD==158){
      document.getElementById("onebox").style.backgroundColor="#DAD061";
      document.getElementById("twobox").style.backgroundColor="#F5EBB0";
      document.getElementById("threebox").style.backgroundColor="#DAD061";
      document.getElementById("fourbox").style.backgroundColor="#DAD061";
      document.getElementById("fivebox").style.backgroundColor="#DAD061";
      document.getElementById("sixbox").style.backgroundColor="#DAD061";
    ...
    ||NRD==120||NRD==121||NRD==122||NRD==159||NRD==160||NRD==161||NRD==162){
      document.getElementById("onebox").style.backgroundColor="#DAD061";
      document.getElementById("twobox").style.backgroundColor="#DAD061";
      document.getElementById("threebox").style.backgroundColor="#F5EBB0";
      document.getElementById("fourbox").style.backgroundColor="#DAD061";
      document.getElementById("fivebox").style.backgroundColor="#DAD061";
      document.getElementById("sixbox").style.backgroundColor="#DAD061";
      document.getElementById("sevenbox").style.backgroundColor="#DAD061";
    ...
    ||NRD==124||NRD==125||NRD==126||NRD==163||NRD==164||NRD==165||NRD==166){
      ...
      document.getElementById("twobox").style.backgroundColor="#DAD061";
      document.getElementById("threebox").style.backgroundColor="#DAD061";
      document.getElementById("fourbox").style.backgroundColor="#F5EBB0";
      document.getElementById("fivebox").style.backgroundColor="#DAD061";
      document.getElementById("sixbox").style.backgroundColor="#DAD061";
      document.getElementById("sevenbox").style.backgroundColor="#DAD061";
      document.getElementById("eightbox").style.backgroundColor="#DAD061";
    ...
    ||NRD==128||NRD==129||NRD==130||NRD==167||NRD==168||NRD==169||NRD==170){
      ...
      document.getElementById("threebox").style.backgroundColor="#DAD061";
      document.getElementById("fourbox").style.backgroundColor="#DAD061";
      document.getElementById("fivebox").style.backgroundColor="#F5EBB0";
      document.getElementById("sixbox").style.backgroundColor="#DAD061";
      document.getElementById("sevenbox").style.backgroundColor="#DAD061";
      document.getElementById("eightbox").style.backgroundColor="#DAD061";
      document.getElementById("ninebox").style.backgroundColor="#DAD061";
    ...
    ||NRD==132||NRD==133||NRD==134||NRD==171||NRD==172||NRD==173||NRD==174){
      ...
      document.getElementById("eightbox").style.backgroundColor="#DAD061";
      document.getElementById("ninebox").style.backgroundColor="#DAD061";
      document.getElementById("tenbox").style.backgroundColor="#F5EBB0";
    }
    if(NRD==7||NRD==17||NRD==27||NRD==37||NRD==47||NRD==63
    ||NRD==64||NRD==83||NRD==84||NRD==103||NRD==104||NRD==135
    ||NRD==136||NRD==137||NRD==138||NRD==175||NRD==176||NRD==177||NRD==178){
      ...
      document.getElementById("sevenbox").style.backgroundColor="#DAD061";
      document.getElementById("eightbox").style.backgroundColor="#DAD061";
      document.getElementById("ninebox").style.backgroundColor="#F5EBB0";
      document.getElementById("tenbox").style.backgroundColor="#DAD061";
    }
    if(NRD==8||NRD==18||NRD==28||NRD==38||NRD==48||NRD==65
    ||NRD==66||NRD==85||NRD==86||NRD==105||NRD==106||NRD==139
    ||NRD==140||NRD==141||NRD==142||NRD==179||NRD==180||NRD==181||NRD==182){
      ...
      document.getElementById("sixbox").style.backgroundColor="#DAD061";
      document.getElementById("sevenbox").style.backgroundColor="#DAD061";
      document.getElementById("eightbox").style.backgroundColor="#F5EBB0";
      document.getElementById("ninebox").style.backgroundColor="#DAD061";
      document.getElementById("tenbox").style.backgroundColor="#DAD061";
    }
    if(NRD==9||NRD==19||NRD==29||NRD==39||NRD==49||NRD==67
    ...
    ||NRD==144||NRD==145||NRD==146||NRD==183||NRD==184||NRD==185||NRD==186){
      ...
      document.getElementById("fivebox").style.backgroundColor="#DAD061";
      document.getElementById("sixbox").style.backgroundColor="#DAD061";
      document.getElementById("sevenbox").style.backgroundColor="#F5EBB0";
      document.getElementById("eightbox").style.backgroundColor="#DAD061";
      document.getElementById("ninebox").style.backgroundColor="#DAD061";
      document.getElementById("tenbox").style.backgroundColor="#DAD061";
    }
    ...
    ||NRD==148||NRD==149||NRD==150||NRD==187||NRD==188||NRD==189||NRD==190){
      ...
      document.getElementById("fourbox").style.backgroundColor="#DAD061";
      document.getElementById("fivebox").style.backgroundColor="#DAD061";  
      document.getElementById("sixbox").style.backgroundColor="#F5EBB0";
      document.getElementById("sevenbox").style.backgroundColor="#DAD061";
      document.getElementById("eightbox").style.backgroundColor="#DAD061";
      document.getElementById("ninebox").style.backgroundColor="#DAD061";
      document.getElementById("tenbox").style.backgroundColor="#DAD061";
    ...
    if((NRD==highBreak&&NRD==151)||(NRD==highBreak&&NRD==152)
    ||(NRD==highBreak&&NRD==153)||(NRD==highBreak&&NRD==154)){setTimeout(oneHR,200);}
    function twoHR(){alert("고성능 2번 당첨");location.reload();}
    if((NRD==highBreak&&NRD==155)||(NRD==highBreak&&NRD==156)
    ||(NRD==highBreak&&NRD==157)||(NRD==highBreak&&NRD==158)){setTimeout(twoHR,200);}
    function threeHR(){alert("고성능 3번 당첨");location.reload();}
    if((NRD==highBreak&&NRD==159)||(NRD==highBreak&&NRD==160)
    ||(NRD==highBreak&&NRD==161)||(NRD==highBreak&&NRD==162)){setTimeout(threeHR,200);}
    function fourHR(){alert("고성능 4번 당첨");location.reload();}
    if((NRD==highBreak&&NRD==163)||(NRD==highBreak&&NRD==164)
    ||(NRD==highBreak&&NRD==165)||(NRD==highBreak&&NRD==166)){setTimeout(fourHR,200);}
    function fiveHR(){alert("고성능 5번 당첨");location.reload();}
    if((NRD==highBreak&&NRD==167)||(NRD==highBreak&&NRD==168)
    ||(NRD==highBreak&&NRD==169)||(NRD==highBreak&&NRD==170)){setTimeout(fiveHR,200);}
    function sixHR(){alert("고성능 10번 당첨");location.reload();}
    if((NRD==highBreak&&NRD==171)||(NRD==highBreak&&NRD==172)
    ||(NRD==highBreak&&NRD==173)||(NRD==highBreak&&NRD==174)){setTimeout(sixHR,200);}
    function sevenHR(){alert("고성능 9번 당첨");location.reload();}
    if((NRD==highBreak&&NRD==175)||(NRD==highBreak&&NRD==176)
    ||(NRD==highBreak&&NRD==177)||(NRD==highBreak&&NRD==178)){setTimeout(sevenHR,200);}
    function eightHR(){alert("고성능 8번 당첨");location.reload();}
    if((NRD==highBreak&&NRD==179)||(NRD==highBreak&&NRD==180)
    ||(NRD==highBreak&&NRD==181)||(NRD==highBreak&&NRD==182)){setTimeout(eightHR,200);}
    function nineHR(){alert("고성능 7번 당첨");location.reload();}
    if((NRD==highBreak&&NRD==183)||(NRD==highBreak&&NRD==184)
    ||(NRD==highBreak&&NRD==185)||(NRD==highBreak&&NRD==186)){setTimeout(nineHR,200);}
    function tenHR(){alert("고성능 6번 당첨");location.reload();}
    if((NRD==highBreak&&NRD==187)||(NRD==highBreak&&NRD==188)
    ||(NRD==highBreak&&NRD==189||(NRD==highBreak&&NRD==190))){setTimeout(tenHR,200);}
}